        ...
        <AnimatedSection>
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-8">
            ...
            <div className="text-left bg-gray-50 p-6 rounded-lg border w-full md:max-w-sm">
                <p className="mb-2"><strong className="text-gray-700 w-32 inline-block">Ngân hàng:</strong> <span className="text-[#8d6e63]">Vietcombank</span></p>
                <p className="mb-2"><strong className="text-gray-700 w-32 inline-block">Số tài khoản:</strong> <span className="text-[#8d6e63]">0301000384961</span></p>
                <p><strong className="text-gray-700 w-32 inline-block">Chủ tài khoản:</strong> <span className="text-[#8d6e63]">DO QUANG LINH</span></p>
            </div>
          </div>
        </AnimatedSection>
