...
const ContactSectionBride: React.FC = () => {
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <AnimatedSection>
          <div className="grid md:grid-cols-2 gap-12">
            {/* Bride's House Map - Hiển thị trước */}
            <div>
            ...
            {/* Groom's House Map - Hiển thị sau */}
            <div>
...
export default ContactSectionBride;
