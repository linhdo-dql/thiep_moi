...
const TimelineSection: React.FC = () => {
  // Timeline cho nhà trai - chia thành 2 ngày
  const scheduleDay1 = [
    { time: '10:00', title: 'Đón Khách & Khai Tiệc', description: 'Gia đình trân trọng đón tiếp Quý vị và bắt đầu tiệc mừng buổi sáng.' },
    { time: '12:00', title: 'Kết Thúc Tiệc & Giao lưu văn nghệ', description: 'Gia đình gửi lời cảm ơn chân thành tới các vị khách đã tham dự.' },
  ];

  const scheduleDay2 = [
    { time: '9:00', title: 'Đón Khách Lễ Thành Hôn', description: 'Chào đón Quý vị cho nghi lễ chính thức và trang trọng nhất.' },
    { time: '9:30', title: 'Nghi Lễ Thành Hôn', description: 'Khoảnh khắc cô dâu và chú rể trao lời thề nguyện và chính thức nên duyên vợ chồng.' },
